...
>
> 本文是 Phase 1 的早期总览稿,其中的"14 子项目 + 六阶段流程 + Phase 1-4 路线图 + 端到端数据流(含 platform / flow / runtime 三角)"设定与 A 方案的六域 × 26 仓架构不一致。当前权威文档:
>
> - 产品叙事:`product/最终目的.md`
> - 领域模型:`product/六域模型.md`(待写)
> - 仓库拆分:`architecture/仓库拆分方案.md`(A 方案版)
>

...
| R-SDK-007 | stale / unknown source 被配置成 fresh，或 SDK 复制 core / bus truth | PH-02 / PH-04 | freshness state tests、contract source tests、query no-write tests | `commit-02-b` 前 |

...
| PH-04 | 本地 package candidate 与三语言产物 | 基于 fresh view 和 baseline 生成 local candidate,构建 Rust / Python / TypeScript package artifact metadata | PH-03 | package candidate service、language generator、package builder、language artifact、package layout checks | `TC-SDK-CANDIDATE-*`;package layout check;AC-FUNC-007;VETO-SDK-003 初步可判定 |
...
| PH-02 | 上游契约承接与语义基线 | 承接 core / bus contracts,建立 semantic baseline、derived view、freshness 和基础 query | PH-01 | contracts usage、semantic baseline、derived view、freshness query | `TC-SDK-CONTRACT-*`;`TC-SDK-SEMANTIC-*`;AC-FUNC-001 / 002 |
...
| PH-04 | 本地 package candidate 与三语言产物 | 基于 fresh view 和 baseline 生成 local candidate,构建三语言 package artifact metadata | PH-03 | package candidate、language generator、package builder、language artifacts | `TC-SDK-CANDIDATE-*`;package layout check |

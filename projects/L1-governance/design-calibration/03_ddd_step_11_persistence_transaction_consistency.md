...
| `save_method_policy_snapshot(snapshot, expected_version, uow)` | 保存 method policy snapshot | same UoW as reference state;no method body | `MethodPolicySnapshotRef` | version conflict |

...
| `ConsumeMethodPolicyDefinitionChanged` | envelope dedup key | source family、source event ref、source ref、schema version、source version ref、method policy snapshot ref/state/digest fields | stored receipt;不重写 policy snapshot |

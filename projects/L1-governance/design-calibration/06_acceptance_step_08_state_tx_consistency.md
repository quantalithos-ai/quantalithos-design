...
| AC-GOV-IDEMP-002 | expected_version on existing state | repository / projection / reference / outbox / report writes | `TC-GOV-IDEMP-005~010`;`TC-GOV-OUTBOX-013~015` | `EV-GOV-IDEMP-001`;`EV-GOV-OUTBOX-001` | `reports/runs/<run_id>/suites/infra-runtime-fake.md`;`reports/runs/<run_id>/suites/operations-replay-core.md` | version 来源缺失不通过 |

...
| source commits artifact | `artifacts/test/<run_id>/meta/source-commits.json` | 复核 design / implementation / core contracts / additional source refs |
| config digest artifact | `artifacts/test/<run_id>/meta/config-digest.json` | 复核 config applicability、profile、digest、safe config sources 和 not-applicable reason |

...
| DDD-S6-OPEN-026 | `IdentityProjectionRef` / `ProjectionStateRef` 的正式 builder / lookup / catalog 来源 | summary query、projection rebuild、projection state read、projection fake | Step 7 / Step 11 闭口;当前只固定不得由 query 拼接 |

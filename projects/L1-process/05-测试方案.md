...
| WaitingGate / ProcessCheckpoint / RecoveryAttempt | `03` §6 / §9 | PH-04 起覆盖 open、resume、checkpoint、recover、abandon、expired guard;ResumeWaitingGate missing pause context reject;GetWaitingGate missing pause context degraded | 恢复链断裂 | domain unit + service |

...
|---|---|---|---|---|---|
| 性能样本 | command / query / job / report latency 趋势 | benchmark / load sample | ci-test / integration-like | 生成样本报告,且最小闭环与基础样本无明显 timeout / hang / 主链阻塞;`06` §9 不继承旧版硬阈值 | EV-INTEGRATION-003 |

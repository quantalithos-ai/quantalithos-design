...
> 对应正式文档: `projects/L1-process/02-概要设计.md`
...
| 旧文档不局部修补 | 旧 `02-概要设计.md` 先删除,再按新版 14 章结构分批重建 |
...
正式 `projects/L1-process/02-概要设计.md` 已按新版概要设计主链重建。
...
- 每章保留具体校准来源与延伸阅读入口。
- 正文不保留旧版“先用人话理解本仓 / 项目过程节奏仓 / Template-Profile-Instance 教学叙事”主链。
- 后续可进入 `03-详细设计.md` 校准。

...
| `ResumeWaitingGate_contract` | `ResumeWaitingGateFlow` | resume success;duplicate;decision mismatch;gate already terminal;missing pause context rejects without success side effects;token missing | API + application |

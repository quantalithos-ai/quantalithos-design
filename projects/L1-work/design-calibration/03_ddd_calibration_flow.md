# L1-work 03 详细设计校准工作台

> 对应 SOP: `standards/document/详细设计讨论流程_SOP.md`
> 中间产物规范: `standards/document/设计文档讨论中间产物规范.md`
> 可落码性标准: `standards/document/设计真相源闭环与可落码性标准.md`
> 目标正式文档: `projects/L1-work/03-详细设计.md`
> 创建日期: 2026-06-03
> 当前状态: Step 1~19 已完成;正式 03 已审核收口,可进入后续文档
...
旧版 `03-详细设计.md` 已按用户要求删除。旧主线口径包括 Project `Draft/Paused/Dissolved`、`DraftIteration`、child WorkItem proposal / accepted / rejected 等旧模型,只保留在 git 历史中作为问题诊断输入,不得作为新版详细设计真相源。
...
| 输入 | 权威级别 | 用途 |
|---|---|---|
| `projects/L1-work/00-需求文档.md` | 正式上游 | 需求边界、数据归属、业务规则、验收红线 |
| `projects/L1-work/01-架构设计.md` | 正式上游 | 系统边界、依赖方向、数据所有权、一致性和通信方式 |
| `projects/L1-work/02-概要设计.md` | 直接输入 | 代码主体框架、主要组成部分、对象轮廓、接口骨架、处理流、状态机 |
| `projects/L1-work/design-calibration/02_hld_*` | 解释性输入 | 理解概要设计结论来源;若与正式 `02` 冲突,以正式 `02` 为准 |
| `projects/L1-work/03-详细设计.md` | 已审核收口 | 正式详细设计入口;由 `07-实施计划.md` 引用,并连同校准 Step 作为实现前置阅读 |
...
| Step 19 | 整理正式详细设计文档 | `03_ddd_step_19_formal_document_assembly.md` | [x] 已完成;正式 03 已审核收口 |
...
- 正式 `03-详细设计.md` 已按 Step 19 重建并审核收口;后续文档必须引用正式 `03` 与对应校准 Step。

...
| `DS-WORK-PROJECTION-REBUILD` | projection rebuild success / failure / query surface | seed body-free `ProjectWorkTruthSnapshot` summaries、truth cursor、projection batch failure injection | project + cursor prefix | drop projection store | `OPS-002`、`QUERY-004/005/008` |

...
允许配置容量、超时、并发、端点引用、driver选择、profile、密钥引用、日志采样；禁止配置actor/scope授权、source identity、digest/key算法、状态迁移、projection字段、owner正文、archive语义。
...
| 之前 | 本步后 |
|---|---|
| 配置结论分散或未定义 | 形成可追溯的定义配置分类与禁止配置化边界结论 |

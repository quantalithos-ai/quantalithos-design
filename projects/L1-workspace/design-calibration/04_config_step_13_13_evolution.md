...
schema带版本；新增项不提供隐式值，废弃项窗口由运维批准；迁移只转换配置，不迁移projection/cursor/operation；driver/算法变更需兼容性与回滚审查。
...
| 之前 | 本步后 |
|---|---|
| 配置结论分散或未定义 | 形成可追溯的定义配置迁移、废弃与演进结论 |

...
| gate_status | pending |
| current_design_scope | Host entry wiring |

## Boundary Header

本 boundary 的 planned 功能增量：Host entry wiring。该文件是设计仓预创建台账，不代表代码、测试或提交存在。

## Required Reads

| document | required_section | status | notes |
|---|---|---|---|
| 03-详细设计.md | 03 §4/§5、05 entry、07 Step 6 | pending | 正式文档优先，冲突时暂停回写 |
...
| PH-03 calibration | Step-specific source | pending | Host entry wiring 设计背景 |

## Allowed Scope

- application/fake/API/worker host session entry。
...
|---|---|---|---|
| Design Gate | formal 03/04/05/06/07 与 03 §4/§5、05 entry、07 Step 6 逐项闭环 | pending | source refs only |
...
| Test Gate | GATE-MS-09 对应 targeted suite | pending | not_run |
...
|---|---|---|
| predecessor commit-03-b | pending / blocked | 由 owning source 闭合；未闭合保持 planned / wait_until_current |

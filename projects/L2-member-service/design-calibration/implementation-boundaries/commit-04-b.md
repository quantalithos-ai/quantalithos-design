...
| gate_status | pending |
| current_design_scope | Recovery decision |

## Boundary Header

本 boundary 的 planned 功能增量：Recovery decision。该文件是设计仓预创建台账，不代表代码、测试或提交存在。

## Required Reads

| document | required_section | status | notes |
|---|---|---|---|
| 03-详细设计.md | 03 §9/§11/§12、06 AC-MS-014 | pending | 正式文档优先，冲突时暂停回写 |
...
| PH-04 calibration | Step-specific source | pending | Recovery decision 设计背景 |

## Allowed Scope

- recovery decision、basis、generation fence。
...
- Runtime checkpoint recovery、implicit retry。
...
|---|---|---|---|
| Design Gate | formal 03/04/05/06/07 与 03 §9/§11/§12、06 AC-MS-014 逐项闭环 | pending | source refs only |
...
| Test Gate | GATE-MS-11 对应 targeted suite | pending | not_run |
...
|---|---|---|
| MSVC-UP-001/005 | pending / blocked | 由 owning source 闭合；未闭合保持 planned / wait_until_current |

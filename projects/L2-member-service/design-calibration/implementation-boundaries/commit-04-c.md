...
| gate_status | pending |
| current_design_scope | Health orchestration |

## Boundary Header

本 boundary 的 planned 功能增量：Health orchestration。该文件是设计仓预创建台账，不代表代码、测试或提交存在。

## Required Reads

| document | required_section | status | notes |
|---|---|---|---|
| 03-详细设计.md | 03 §11~§14、04 §11、05 recovery | pending | 正式文档优先，冲突时暂停回写 |
...
| PH-04 calibration | Step-specific source | pending | Health orchestration 设计背景 |

## Allowed Scope

- health/recovery service、fake/disabled adapter。
...
|---|---|---|---|
| Design Gate | formal 03/04/05/06/07 与 03 §11~§14、04 §11、05 recovery 逐项闭环 | pending | source refs only |
...
| Test Gate | GATE-MS-12 对应 targeted suite | pending | not_run |
...
|---|---|---|
| MSVC-OBS-001 | pending / blocked | 由 owning source 闭合；未闭合保持 planned / wait_until_current |

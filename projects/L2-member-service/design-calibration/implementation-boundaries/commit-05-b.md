...
| gate_status | pending |
| current_design_scope | Residual / reconcile |

## Boundary Header

本 boundary 的 planned 功能增量：Residual / reconcile。该文件是设计仓预创建台账，不代表代码、测试或提交存在。

## Required Reads

| document | required_section | status | notes |
|---|---|---|---|
| 03-详细设计.md | 03 §6/§8~§12、06 AC-MS-016 | pending | 正式文档优先，冲突时暂停回写 |
...
| PH-05 calibration | Step-specific source | pending | Residual / reconcile 设计背景 |

## Allowed Scope

- finding、case、safe comparison。
...
- 修改 sibling truth、unavailable→resolved。
...
|---|---|---|---|
| Design Gate | formal 03/04/05/06/07 与 03 §6/§8~§12、06 AC-MS-016 逐项闭环 | pending | source refs only |
...
| Test Gate | GATE-MS-14 对应 targeted suite | pending | not_run |

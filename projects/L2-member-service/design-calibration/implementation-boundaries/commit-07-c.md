...
| gate_status | pending |
| current_design_scope | Operations jobs |

## Boundary Header

本 boundary 的 planned 功能增量：Operations jobs。该文件是设计仓预创建台账，不代表代码、测试或提交存在。

## Required Reads

| document | required_section | status | notes |
|---|---|---|---|
| 03-详细设计.md | 03 §7.5/§8.5、05 jobs、06 §5/§8 | pending | 正式文档优先，冲突时暂停回写 |
...
| PH-07 calibration | Step-specific source | pending | Operations jobs 设计背景 |

## Allowed Scope

- 7 jobs、selector、report、worker/job entry。
...
|---|---|---|---|
| Design Gate | formal 03/04/05/06/07 与 03 §7.5/§8.5、05 jobs、06 §5/§8 逐项闭环 | pending | source refs only |
...
| Test Gate | GATE-MS-21 对应 targeted suite | pending | not_run |
...
|---|---|---|
| predecessor commit-07-b | pending / blocked | 由 owning source 闭合；未闭合保持 planned / wait_until_current |

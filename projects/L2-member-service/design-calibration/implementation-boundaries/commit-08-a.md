...
| gate_status | pending |
| current_design_scope | Fixture / gates |

## Boundary Header

本 boundary 的 planned 功能增量：Fixture / gates。该文件是设计仓预创建台账，不代表代码、测试或提交存在。

## Required Reads

| document | required_section | status | notes |
|---|---|---|---|
| 03-详细设计.md | 05 §9/§13、06 §10、07 Step 7 | pending | 正式文档优先，冲突时暂停回写 |
...
| PH-08 calibration | Step-specific source | pending | Fixture / gates 设计背景 |

## Allowed Scope

- fixture manifest、gate/check scripts。
...
|---|---|---|---|
| Design Gate | formal 03/04/05/06/07 与 05 §9/§13、06 §10、07 Step 7 逐项闭环 | pending | source refs only |
...
| Test Gate | GATE-MS-22 对应 targeted suite | pending | not_run |
...
|---|---|---|
| predecessor PH-07 | pending / blocked | 由 owning source 闭合；未闭合保持 planned / wait_until_current |

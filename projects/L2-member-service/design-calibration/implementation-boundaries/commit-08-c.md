...
| gate_status | pending |
| current_design_scope | Release / handoff |

## Boundary Header

本 boundary 的 planned 功能增量：Release / handoff。该文件是设计仓预创建台账，不代表代码、测试或提交存在。

## Required Reads

| document | required_section | status | notes |
|---|---|---|---|
| 03-详细设计.md | 03 §7~§14；05 §9/§13/§14；06 §11~§14 | pending | 正式文档优先，冲突时暂停回写 |
...
| PH-08 calibration | Step-specific source | pending | Release / handoff 设计背景 |

## Allowed Scope

- release smoke、handoff/open-issues draft。
...
|---|---|---|---|
| Design Gate | formal 03/04/05/06/07 与 05 §9/§13/§14、06 §11~§14 逐项闭环 | pending | source refs only |
...
| Test Gate | GATE-MS-24 对应 targeted suite | pending | not_run |
...
|---|---|---|
| predecessor commit-08-b | pending / blocked | 由 owning source 闭合；未闭合保持 planned / wait_until_current |

# commit-01-b — planned boundary skeleton
...
| phase | PH-01 |
| stable IMPL | IMPL-01-04~06 |
| stable BATCH | BATCH-01-04~06 |
| stable Gate | GATE-02 |
| baseline | not_bound |
...
**shared vocabulary** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: typed ids/refs/scope/metadata/digest;
...
- owning tests and checks for GATE-02.

## Forbidden Scope

- duplicate Core types, provider/body fields;
...
|---|---|---|
| A | IMPL-01-04 / BATCH-01-04 | typed carriers, factories and domain invariant |
| B | IMPL-01-05 / BATCH-01-05 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-01-06 / BATCH-01-06 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |

# commit-02-a — planned boundary skeleton
...
| phase | PH-02 |
| stable IMPL | IMPL-02-01~03 |
| stable BATCH | BATCH-02-01~03 |
| stable Gate | GATE-04 |
| baseline | not_bound |
...
**method-level Ports** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: Port traits and record/version/cursor carriers;
...
- owning tests and checks for GATE-04.

## Forbidden Scope

- generic save/business mutation/product clients;
...
|---|---|---|
| A | IMPL-02-01 / BATCH-02-01 | typed carriers, factories and domain invariant |
| B | IMPL-02-02 / BATCH-02-02 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-02-03 / BATCH-02-03 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |

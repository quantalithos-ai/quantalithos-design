# commit-02-b — planned boundary skeleton
...
| phase | PH-02 |
| stable IMPL | IMPL-02-04~06 |
| stable BATCH | BATCH-02-04~06 |
| stable Gate | GATE-05 |
| baseline | not_bound |
...
**local stores and UoW** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: CAS, append, inbox/outbox, idempotency, replay;
...
- owning tests and checks for GATE-05.

## Forbidden Scope

- LWW, partial commit, broker/DB choice;
...
|---|---|---|
| A | IMPL-02-04 / BATCH-02-04 | typed carriers, factories and domain invariant |
| B | IMPL-02-05 / BATCH-02-05 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-02-06 / BATCH-02-06 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |

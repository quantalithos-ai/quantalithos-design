# commit-02-c — planned boundary skeleton
...
| field | value |
|---|---|
| boundary | commit-02-c |
| phase | PH-02 |
| stable IMPL | IMPL-02-07~09 |
| stable BATCH | BATCH-02-07~09 |
| stable Gate | GATE-06 |
| baseline | not_bound |
...
**Unknown/lease/page kernel** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: Unknown/fence, lease/page/cursor and journals;
...
- owning tests and checks for GATE-06.

## Forbidden Scope

- blind retry, cursor skip, scheduler product;
...
|---|---|---|
| A | IMPL-02-07 / BATCH-02-07 | typed carriers, factories and domain invariant |
| B | IMPL-02-08 / BATCH-02-08 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-02-09 / BATCH-02-09 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |
...
| phase/owner/dependency/Rustdoc | pass-designed; blocker: SP-L2R-002; predecessor/product binding |
...
|---|---|---|---|
| SP-L2R-002; predecessor/product binding | open/pending | affected activation or positive scope remains blocked | fake, path existence, ACK, ping, planned text |

# commit-03-a — planned boundary skeleton
...
| phase | PH-03 |
| stable IMPL | IMPL-03-01~03 |
| stable BATCH | BATCH-03-01~03 |
| stable Gate | GATE-07 |
| baseline | not_bound |
...
**loop cursor/snapshot/activation** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: RuntimeLoopCursor/LoopSnapshot/LoopActivation;
...
- owning tests and checks for GATE-07.

## Forbidden Scope

- admission policy/model/action/checkpoint calls;
...
|---|---|---|
| A | IMPL-03-01 / BATCH-03-01 | typed carriers, factories and domain invariant |
| B | IMPL-03-02 / BATCH-03-02 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-03-03 / BATCH-03-03 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |

# commit-03-b — planned boundary skeleton
...
| phase | PH-03 |
| stable IMPL | IMPL-03-04~06 |
| stable BATCH | BATCH-03-04~06 |
| stable Gate | GATE-08 |
| baseline | not_bound |
...
**wakeup/continuation/yield** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: RuntimeWakeup/LocalContinuation/HardYield/Reservation;
...
- owning tests and checks for GATE-08.

## Forbidden Scope

- scheduler product/recursive self-wakeup;
...
|---|---|---|
| A | IMPL-03-04 / BATCH-03-04 | typed carriers, factories and domain invariant |
| B | IMPL-03-05 / BATCH-03-05 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-03-06 / BATCH-03-06 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |

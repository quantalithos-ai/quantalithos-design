# commit-04-a — planned boundary skeleton
...
| phase | PH-04 |
| stable IMPL | IMPL-04-01~03 |
| stable BATCH | BATCH-04-01~03 |
| stable Gate | GATE-10 |
| baseline | not_bound |
...
**admission/run/plan domain** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: admission/run/goal/plan/revision/progress state;
...
- owning tests and checks for GATE-10.

## Forbidden Scope

- loop recursion/Method body/context calls;
...
|---|---|---|
| A | IMPL-04-01 / BATCH-04-01 | typed carriers, factories and domain invariant |
| B | IMPL-04-02 / BATCH-04-02 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-04-03 / BATCH-04-03 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |

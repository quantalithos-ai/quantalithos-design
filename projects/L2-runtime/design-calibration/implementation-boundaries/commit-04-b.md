# commit-04-b — planned boundary skeleton
...
| phase | PH-04 |
| stable IMPL | IMPL-04-04~06 |
| stable BATCH | BATCH-04-04~06 |
| stable Gate | GATE-11 |
| baseline | not_bound |
...
**accepted-only admission/control** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: accepted-only writes and control UoW;
...
- owning tests and checks for GATE-11.

## Forbidden Scope

- nonaccepted run creation/policy mutation/query writes;
...
|---|---|---|
| A | IMPL-04-04 / BATCH-04-04 | typed carriers, factories and domain invariant |
| B | IMPL-04-05 / BATCH-04-05 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-04-06 / BATCH-04-06 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |

# commit-05-a — planned boundary skeleton
...
| phase | PH-05 |
| stable IMPL | IMPL-05-01~03 |
| stable BATCH | BATCH-05-01~03 |
| stable Gate | GATE-13 |
| baseline | not_bound |
...
**source/context state** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: source snapshot/retrieval/context segment/window;
...
- owning tests and checks for GATE-13.

## Forbidden Scope

- durable body/index/lifecycle/provider materialization;
...
|---|---|---|
| A | IMPL-05-01 / BATCH-05-01 | typed carriers, factories and domain invariant |
| B | IMPL-05-02 / BATCH-05-02 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-05-03 / BATCH-05-03 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |

# commit-05-b — planned boundary skeleton
...
| phase | PH-05 |
| stable IMPL | IMPL-05-04~06 |
| stable BATCH | BATCH-05-04~06 |
| stable Gate | GATE-14 |
| baseline | not_bound |
...
**working memory mediation** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: working memory use/exclusion/compaction;
...
- owning tests and checks for GATE-14.

## Forbidden Scope

- durable owner writes/current substitution;
...
|---|---|---|
| A | IMPL-05-04 / BATCH-05-04 | typed carriers, factories and domain invariant |
| B | IMPL-05-05 / BATCH-05-05 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-05-06 / BATCH-05-06 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |

# commit-05-c — planned boundary skeleton
...
| field | value |
|---|---|
| boundary | commit-05-c |
| phase | PH-05 |
| stable IMPL | IMPL-05-07~09 |
| stable BATCH | BATCH-05-07~09 |
| stable Gate | GATE-15 |
| baseline | not_bound |
...
**source consumers/maintenance** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: source consumer and bounded maintenance jobs;
...
- owning tests and checks for GATE-15.

## Forbidden Scope

- scheduler/container/durable readiness;
...
|---|---|---|
| A | IMPL-05-07 / BATCH-05-07 | typed carriers, factories and domain invariant |
| B | IMPL-05-08 / BATCH-05-08 | application service, Port, UoW, local adapter/fake parity |
| C | IMPL-05-09 / BATCH-05-09 | entry/consumer/job plus negative/replay/Unknown/zero-write tests |
...
| phase/owner/dependency/Rustdoc | pass-designed; blocker: L2R-UP-005; durable positive blocked |
...
|---|---|---|---|
| L2R-UP-005; durable positive blocked | open/pending | affected activation or positive scope remains blocked | fake, path existence, ACK, ping, planned text |

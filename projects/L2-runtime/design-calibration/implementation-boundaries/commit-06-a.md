# commit-06-a — planned boundary skeleton
...
| phase | PH-06 |
| stable IMPL | IMPL-06-01~03 |
| stable BATCH | BATCH-06-01~03 |
| stable Gate | GATE-16 |
| baseline | not_bound |
...
**model intent/turn/result** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: intent/binding/turn/result carriers;
- exact formal/calibration rows named above;
- deterministic local/fail-closed adapter seam only where formal sources allow;
- owning tests/checks mapped to GATE-16.

## Forbidden Scope

- provider SDK/route/secret/quota/cost/raw response;
...
|---|---|---|
| A | IMPL-06-01 / BATCH-06-01 | typed carriers, factories and domain invariant |
| B | IMPL-06-02 / BATCH-06-02 | application service, Port, UoW and local seam |
| C | IMPL-06-03 / BATCH-06-03 | entry/consumer/job and negative/replay/Unknown tests |

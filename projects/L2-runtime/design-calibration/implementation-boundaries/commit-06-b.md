# commit-06-b — planned boundary skeleton
...
| phase | PH-06 |
| stable IMPL | IMPL-06-04~06 |
| stable BATCH | BATCH-06-04~06 |
| stable Gate | GATE-17 |
| baseline | not_bound |
...
**two-UoW submission** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
|---|---|---|
| A | IMPL-06-04 / BATCH-06-04 | typed carriers, factories and domain invariant |
| B | IMPL-06-05 / BATCH-06-05 | application service, Port, UoW and local seam |
| C | IMPL-06-06 / BATCH-06-06 | entry/consumer/job and negative/replay/Unknown tests |

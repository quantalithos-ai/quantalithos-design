# commit-07-a — planned boundary skeleton
...
| phase | PH-07 |
| stable IMPL | IMPL-07-01~03 |
| stable BATCH | BATCH-07-01~03 |
| stable Gate | GATE-19 |
| baseline | not_bound |
...
**action guard/attempt state** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: action choice/guard/precondition/attempt/marker;
- exact formal/calibration rows named above;
- deterministic local/fail-closed adapter seam only where formal sources allow;
- owning tests/checks mapped to GATE-19.

## Forbidden Scope

- tool executor/registry/approval/isolation truth;
...
|---|---|---|
| A | IMPL-07-01 / BATCH-07-01 | typed carriers, factories and domain invariant |
| B | IMPL-07-02 / BATCH-07-02 | application service, Port, UoW and local seam |
| C | IMPL-07-03 / BATCH-07-03 | entry/consumer/job and negative/replay/Unknown tests |

# commit-09-b — planned boundary skeleton
...
| field | value |
|---|---|
| boundary | commit-09-b |
| phase | PH-09 |
| stable IMPL | IMPL-09-04~06 |
| stable BATCH | BATCH-09-04~06 |
| stable Gate | GATE-26 |
| baseline | not_bound |
...
**matching receipt/recovery** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: matching receipt/CommitUnknown/recovery fence;
- exact formal/calibration rows named above;
- deterministic local/fail-closed adapter seam only where formal sources allow;
- owning tests/checks mapped to GATE-26.

## Forbidden Scope

- blind resume/retry/mismatch promotion;
...
|---|---|---|
| A | IMPL-09-04 / BATCH-09-04 | typed carriers, factories and domain invariant |
| B | IMPL-09-05 / BATCH-09-05 | application service, Port, UoW and local seam |
| C | IMPL-09-06 / BATCH-09-06 | entry/consumer/job and negative/replay/Unknown tests |

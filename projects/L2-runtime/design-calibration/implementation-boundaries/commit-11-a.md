# commit-11-a — planned boundary skeleton

> phase: PH-11 Projection, Events & Jobs
...
| field | value |
|---|---|
| boundary | commit-11-a |
| phase | PH-11 |
| stable IMPL | IMPL-11-01~03 |
| stable BATCH | BATCH-11-01~03 |
| stable Gate | GATE-31 |
| baseline | not_bound |
...
**history-only projection/rebuild** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: projection/query and bounded history rebuild;
- exact formal/calibration rows named above;
- deterministic local/fail-closed adapter seam only where formal sources allow;
- owning tests/checks mapped to GATE-31.

## Forbidden Scope

- domain repair/writeback/projection authority;
...
|---|---|---|
| A | IMPL-11-01 / BATCH-11-01 | typed carriers, factories and domain invariant |
| B | IMPL-11-02 / BATCH-11-02 | application service, Port, UoW and local seam |
| C | IMPL-11-03 / BATCH-11-03 | entry/consumer/job and negative/replay/Unknown tests |
...
| phase/owner/dependency/Rustdoc | pass-designed; blocker: L2R-UP-002/006/007; predecessor truth |
...
|---|---|---|---|
| L2R-UP-002/006/007; predecessor truth | open/pending | affected activation or positive scope remains blocked | fake, path existence, ACK, ping, planned text |

# commit-11-c — planned boundary skeleton
...
| field | value |
|---|---|
| boundary | commit-11-c |
| phase | PH-11 |
| stable IMPL | IMPL-11-07~09 |
| stable BATCH | BATCH-11-07~09 |
| stable Gate | GATE-33 |
| baseline | not_bound |
...
**immutable outbox publisher** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: outbox publisher and bounded cursor job;
- exact formal/calibration rows named above;
- deterministic local/fail-closed adapter seam only where formal sources allow;
- owning tests/checks mapped to GATE-33.

## Forbidden Scope

- broker/DLQ/delivery/Observed backend;
...
|---|---|---|
| A | IMPL-11-07 / BATCH-11-07 | typed carriers, factories and domain invariant |
| B | IMPL-11-08 / BATCH-11-08 | application service, Port, UoW and local seam |
| C | IMPL-11-09 / BATCH-11-09 | entry/consumer/job and negative/replay/Unknown tests |

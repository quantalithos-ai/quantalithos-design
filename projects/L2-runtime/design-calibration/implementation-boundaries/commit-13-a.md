# commit-13-a — planned boundary skeleton
...
| field | value |
|---|---|
| boundary | commit-13-a |
| phase | PH-13 |
| stable IMPL | IMPL-13-01~03 |
| stable BATCH | BATCH-13-01~03 |
| stable Gate | GATE-37 |
| baseline | not_bound |
...
**manifests/raw runners** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: 37 CUT/177 TC-EV/8 suite manifests/raw;
- exact formal/calibration rows named above;
- deterministic local/fail-closed adapter seam only where formal sources allow;
- owning tests/checks mapped to GATE-37.

## Forbidden Scope

- static evidence/empty selector/project-nested path;
...
|---|---|---|
| A | IMPL-13-01 / BATCH-13-01 | typed carriers, factories and domain invariant |
| B | IMPL-13-02 / BATCH-13-02 | application service, Port, UoW and local seam |
| C | IMPL-13-03 / BATCH-13-03 | entry/consumer/job and negative/replay/Unknown tests |

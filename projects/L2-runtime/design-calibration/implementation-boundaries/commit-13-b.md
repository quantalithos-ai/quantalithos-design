# commit-13-b — planned boundary skeleton
...
| field | value |
|---|---|
| boundary | commit-13-b |
| phase | PH-13 |
| stable IMPL | IMPL-13-04~06 |
| stable BATCH | BATCH-13-04~06 |
| stable Gate | GATE-38 |
| baseline | not_bound |
...
**nine checks/reports/index** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: 9 checks/reports/index/digest pairing;
- exact formal/calibration rows named above;
- deterministic local/fail-closed adapter seam only where formal sources allow;
- owning tests/checks mapped to GATE-38.

## Forbidden Scope

- cross-run/handwritten report/status promotion;
...
|---|---|---|
| A | IMPL-13-04 / BATCH-13-04 | typed carriers, factories and domain invariant |
| B | IMPL-13-05 / BATCH-13-05 | application service, Port, UoW and local seam |
| C | IMPL-13-06 / BATCH-13-06 | entry/consumer/job and negative/replay/Unknown tests |

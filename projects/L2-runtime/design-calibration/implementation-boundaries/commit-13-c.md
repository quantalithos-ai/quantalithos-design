# commit-13-c — planned boundary skeleton

> phase: PH-13 Quality & Handoff Tooling
...
| field | value |
|---|---|
| boundary | commit-13-c |
| phase | PH-13 |
| stable IMPL | IMPL-13-07~09 |
| stable BATCH | BATCH-13-07~09 |
| stable Gate | GATE-39 |
| baseline | not_bound |
...
**local aggregation/review drafts** is one reviewable functional increment. It must not invent fields, states, Ports, configuration defaults, evidence or owner truth.
...
- Batch A: local aggregate/lane separation/four drafts;
- exact formal/calibration rows named above;
- deterministic local/fail-closed adapter seam only where formal sources allow;
- owning tests/checks mapped to GATE-39.

## Forbidden Scope

- verdict/signoff/risk acceptance/readiness;
...
|---|---|---|
| A | IMPL-13-07 / BATCH-13-07 | typed carriers, factories and domain invariant |
| B | IMPL-13-08 / BATCH-13-08 | application service, Port, UoW and local seam |
| C | IMPL-13-09 / BATCH-13-09 | entry/consumer/job and negative/replay/Unknown tests |
...
| phase/owner/dependency/Rustdoc | pass-designed; blocker: L2R-IMPL-001; tooling absent |
...
|---|---|---|---|
| L2R-IMPL-001; tooling absent | open/pending | affected activation or positive scope remains blocked | fake, path existence, ACK, ping, planned text |

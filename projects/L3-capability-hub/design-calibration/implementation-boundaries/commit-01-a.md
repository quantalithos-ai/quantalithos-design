...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-01-a row, batches and scope | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-01-a gate row | pending | Exact selector and command contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-01-a readiness row | pending | Exact prerequisite and unavailable behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-01-a title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 sections 3-4; DDD Steps 3-4; formal 07 sections 3, 6, 7, 8, 10, 11, 12 | pending | Exact schema and truth remain upstream-owned. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | root Cargo manifest; seven member manifests and source skeletons; package/lib/binary naming checks; dependency-boundary checks | planned |
| allowed_rule | BATCH-01-A1 manifest/layout -> BATCH-01-A2 seven member skeletons -> BATCH-01-A3 dependency/name/static checks | planned |
...
| forbidden_rule | business DTO/domain/application/service code; configuration values; copied or vendored core contracts; any sibling Cargo path dependency | active |
...
|---|---|---|
| BATCH-01-A1 manifest/layout -> BATCH-01-A2 seven member skeletons -> BATCH-01-A3 dependency/name/static checks | each batch is a 100-300 line locally verifiable increment | planned |
...
| commit_message_format | pending | Planned subject: chore(workspace): establish the capability hub workspace skeleton |
| commit_body_group | pending | Required groups: Workspace and member layout:; Dependency and naming boundaries: |

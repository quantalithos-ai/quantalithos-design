...
|---|---|---|
| project ledger current_boundary equals commit-02-b | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-02-b row, batches and scope | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-02-b gate row | pending | Exact selector and command contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-02-b readiness row | pending | Exact prerequisite and unavailable behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-02-b title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 sections 6 and 10; DDD Steps 6, 10 and 12; formal 05 state-pair registry; formal 07 sections 3, 6, 7, 8, 10, 11, 12 | pending | Exact schema and truth remain upstream-owned. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | domain state guards, policy/invariant/error support and pure tests; canonical 638 state-pair consumers | planned |
| allowed_rule | BATCH-02-B1 state families -> BATCH-02-B2 policies/invariants -> BATCH-02-B3 pure negative tests | planned |
...
| forbidden_rule | repository/UoW/config/external truth; runtime/tools execution; approval truth; method body/source; state inferred from strings | active |
...
|---|---|---|
| BATCH-02-B1 state families -> BATCH-02-B2 policies/invariants -> BATCH-02-B3 pure negative tests | each batch is a 100-300 line locally verifiable increment | planned |
...
| planned reviewer | domain owner + test owner |
| planned title | feat(domain): add capability state and policy foundations |
| required body groups | State and error foundations:; Policies and invariant tests: |
...
| commit_message_format | pending | Planned subject: feat(domain): add capability state and policy foundations |
| commit_body_group | pending | Required groups: State and error foundations:; Policies and invariant tests: |
...
|---|---|---|---|---|---|
| BLK-CH-02-B-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

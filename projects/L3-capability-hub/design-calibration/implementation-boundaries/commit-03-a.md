...
| phase | PH-03 |
| design_baseline | planned-after-commit-02-c |
...
|---|---|---|
| project ledger current_boundary equals commit-03-a | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-03-a row, batches and scope | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-03-a gate row | pending | Exact selector and command contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-03-a readiness row | pending | Exact prerequisite and unavailable behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-03-a title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 exact C01-C04 and Q01-Q03 sections; DDD Steps 6, 8, 9 and 10; formal 07 sections 3, 6, 7, 8, 10, 11, 12 | pending | Exact schema and truth remain upstream-owned. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | identity/access-review contract and domain files, state/factory rules and pure fixtures | planned |
| allowed_rule | BATCH-03-A1 identity DTO/ref -> BATCH-03-A2 review state/rules -> BATCH-03-A3 pure fixtures | planned |
...
| forbidden_rule | registry; adapter descriptor; governance approval truth; allowlist; provider/runtime semantics | active |
...
|---|---|---|
| BATCH-03-A1 identity DTO/ref -> BATCH-03-A2 review state/rules -> BATCH-03-A3 pure fixtures | each batch is a 100-300 line locally verifiable increment | planned |
...
| evidence_contract | targeted rows reference commit-03-c primary IDs and record no duplicate primary; no new EV |
| AC_VF_VETO_direction | AC-CH-001/006..008/023/029; VF-CH-001/002/003; VETO-CH-001/002/003 |
| failure_return | URL/provider/config identity substitution, identity ambiguity or access-review/Rustdoc gap is a veto or `wait_design`; do not add a runtime allowlist. |
| execution_status | Planned contract only; no command, test, run, artifact, report or evidence instance has been created. |
| planned reviewer | identity owner + design closure reviewer |
| planned title | feat(identity): add capability identity and access review contracts |
| required body groups | Identity contracts:; Access review state and guards: |
...
| targeted behavior | CMD-001..004; QUERY-001..003; STATE-001..002 | pending | No test result exists. |
| evidence/provenance | targeted rows reference commit-03-c primary IDs and record no duplicate primary; no new EV | pending | Planned paths are not evidence. |
...
| commit_message_format | pending | Planned subject: feat(identity): add capability identity and access review contracts |
| commit_body_group | pending | Required groups: Identity contracts:; Access review state and guards: |
...
|---|---|---|---|---|---|
| BLK-CH-03-A-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

...
| phase | PH-04 |
| design_baseline | planned-after-commit-03-c |
...
|---|---|---|
| project ledger current_boundary equals commit-04-a | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-04-a row, batches and scope | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-04-a gate row | pending | Exact selector and command contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-04-a readiness row | pending | Exact prerequisite and unavailable behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-04-a title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 C09-C12 and Q07-Q10; DDD Steps 6, 8 and 10; formal 05 redaction cuts; formal 07 sections 3, 6, 7, 8, 10, 11, 12 | pending | Exact schema and truth remain upstream-owned. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | descriptor/risk/secret-safe contracts and domain guards; typed secret refs; body-free and redaction tests | planned |
| allowed_rule | BATCH-04-A1 descriptor contract -> BATCH-04-A2 risk/secret-safe domain -> BATCH-04-A3 body-free tests | planned |
...
| forbidden_rule | secret values; provider response/body; runtime execution; route/quota/cost; KMS/Vault operation | active |
...
|---|---|---|
| BATCH-04-A1 descriptor contract -> BATCH-04-A2 risk/secret-safe domain -> BATCH-04-A3 body-free tests | each batch is a 100-300 line locally verifiable increment | planned |
...
| evidence_contract | safe summary/ref, typed secret ref, risk state and body-free negative raw; findings contain only safe location/class |
| AC_VF_VETO_direction | AC-CH-003/012..014/031..032; VF-CH-004/011; VETO-CH-004/011; VETO-CH-P-005 |
| failure_return | Raw body, secret value or provider runtime truth leakage is an immediate veto; descriptor field/Rustdoc/redaction gap returns to formal 03. |
| execution_status | Planned contract only; no command, test, run, artifact, report or evidence instance has been created. |
| planned reviewer | descriptor owner + security/redaction reviewer |
| planned title | feat(descriptor): add safe adapter descriptor contracts |
| required body groups | Descriptor contracts:; Risk and secret-safe guards: |
...
| targeted behavior | CMD-009..012; QUERY-007..011; STATE-004..006 | pending | No test result exists. |
| evidence/provenance | safe summary/ref, typed secret ref, risk state and body-free negative raw; findings contain only safe location/class | pending | Planned paths are not evidence. |
...
| commit_message_format | pending | Planned subject: feat(descriptor): add safe adapter descriptor contracts |
| commit_body_group | pending | Required groups: Descriptor contracts:; Risk and secret-safe guards: |
...
|---|---|---|---|---|---|
| BLK-CH-04-A-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

...
| phase | PH-05 |
| design_baseline | planned-after-commit-04-b |
...
| item | contract |
|---|---|
| objective | Establish governance seam and method-library body-free relation contracts. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-05-a |
| allowed scope | governance seam refs/results, method relation state/guards and body-free tests |
| forbidden scope | approval/Policy truth, shared rules, method body/source and execution lifecycle |
| batch sequence | BATCH-05-A1 seam refs/results -> BATCH-05-A2 relation state/guards -> BATCH-05-A3 body-free tests |
| primary or targeted selectors | targeted CMD-013..017; QUERY-012..014; STATE-007..008; INBOUND-001..002 |
| readiness prerequisite | governance/method safe refs, relation state and responsibility/redaction fixtures |
| gate set | GATE-01,GATE-02,GATE-05,GATE-07 |
| planned reviewer | relation owner + governance/method boundary reviewers |
| planned title | feat(relation): add governance and method relation contracts |
| required body groups | Governance seam contracts:; Method relation and body-free guards: |
| next boundary | commit-05-b |

## Activation Guard

| rule | status | consequence |
|---|---|---|
| project ledger current boundary equals commit-05-a | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-05-a exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-05-a exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-05-a readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-05-a title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 C13-C17/Q11-Q14/I01-I02; DDD Steps 6,8,10; formal 05 responsibility cuts | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | governance seam refs/results, method relation state/guards and body-free tests | planned |
| allowed_rule | BATCH-05-A1 seam refs/results -> BATCH-05-A2 relation state/guards -> BATCH-05-A3 body-free tests; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | approval/Policy truth, shared rules, method body/source and execution lifecycle | active |
...
|---|---|---|
| BATCH-05-A1 seam refs/results -> BATCH-05-A2 relation state/guards -> BATCH-05-A3 body-free tests | each batch is a 100-300 line locally verifiable increment | planned |
...
| evidence_contract | governance result/policy approval ref, access review and method asset ref/summary must be body-free and owner-separated; no new EV |
| AC_VF_VETO_direction | AC-CH-004,015..017,027,031..032; VF-CH-005,006,011; VETO-CH-005,006,011; VETO-CH-P-005/008 |
| failure_return | approval/Policy/shared-rules or method body/source leakage is an immediate VETO; field/state closure gaps return to formal 03 |
...
|---|---|---|
| targeted selector | targeted CMD-013..017; QUERY-012..014; STATE-007..008; INBOUND-001..002, expanded to exact TC/DS/EV identities at execution time | pending |
...
| commit_message_format | pending | Planned subject: feat(relation): add governance and method relation contracts |
| commit_body_group | pending | Required groups: Governance seam contracts:; Method relation and body-free guards: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-05-b |
...
|---|---|---|---|---|---|
| BLK-CH-05-A-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

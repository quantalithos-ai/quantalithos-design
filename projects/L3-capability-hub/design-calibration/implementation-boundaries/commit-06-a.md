...
| item | contract |
|---|---|
| objective | Establish formal exposure, applicability and visibility contract foundations. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-06-a |
| allowed scope | exposure/applicability/visibility contracts, state guards and pure tests |
| forbidden scope | runtime allow/deny, SDK client/cache, marketplace listing and consumer execution |
| batch sequence | BATCH-06-A1 exposure DTO -> BATCH-06-A2 applicability/visibility state -> BATCH-06-A3 pure tests |
| primary or targeted selectors | targeted CMD-018..021; QUERY-015..019; STATE-009..014 |
| readiness prerequisite | exposure/applicability/visibility typed fixtures and source-symmetry guards |
| gate set | GATE-01,GATE-02,GATE-07 |
| planned reviewer | exposure owner + SDK boundary reviewer |
| planned title | feat(exposure): add formal exposure and visibility contracts |
| required body groups | Exposure contracts:; Visibility state and guards: |
...
|---|---|---|
| project ledger current boundary equals commit-06-a | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-06-a exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-06-a exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-06-a readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-06-a title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 C18-C21/Q15-Q19; DDD Steps 6,8,10; formal 05 exposure cuts | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | exposure/applicability/visibility contracts, state guards and pure tests | planned |
| allowed_rule | BATCH-06-A1 exposure DTO -> BATCH-06-A2 applicability/visibility state -> BATCH-06-A3 pure tests; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | runtime allow/deny, SDK client/cache, marketplace listing and consumer execution | active |
...
|---|---|---|
| BATCH-06-A1 exposure DTO -> BATCH-06-A2 applicability/visibility state -> BATCH-06-A3 pure tests | each batch is a 100-300 line locally verifiable increment | planned |
...
| evidence_contract | applicability, prerequisites, visibility and source-symmetric guards must be typed; no runtime allow/deny or SDK client/cache |
| AC_VF_VETO_direction | AC-CH-005,014,019,020,028..030; VF-CH-007,008,009; VETO-CH-007,008; VETO-CH-P-008/009 |
| failure_return | unresolved or ungoverned exposure or missing source is wait_design; runtime/tool/SDK ownership is VETO |
...
|---|---|---|
| targeted selector | targeted CMD-018..021; QUERY-015..019; STATE-009..014, expanded to exact TC/DS/EV identities at execution time | pending |
...
| commit_message_format | pending | Planned subject: feat(exposure): add formal exposure and visibility contracts |
| commit_body_group | pending | Required groups: Exposure contracts:; Visibility state and guards: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-06-b |
...
|---|---|---|---|---|---|
| BLK-CH-06-A-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

...
| item | contract |
|---|---|
| objective | Complete controlled consumer views and server exposure services. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-06-b |
| allowed scope | view material, visibility resolver/assembler, server exposure facade and freshness tests |
| forbidden scope | query-triggered repair, runtime execution, SDK client/cache and marketplace listing |
| batch sequence | BATCH-06-B1 view material -> BATCH-06-B2 resolver/assembler -> BATCH-06-B3 server facade -> BATCH-06-B4 freshness tests |
| primary or targeted selectors | CMD-018..021; QUERY-015..019; JOB-002 read input |
| readiness prerequisite | visibility resolver, view store, consumer ref bindings and API root |
| gate set | GATE-01,GATE-02,GATE-03,GATE-04,GATE-05,GATE-06,GATE-07 |
| planned reviewer | exposure owner + query reviewer |
| planned title | feat(exposure-service): add controlled consumer exposure services |
| required body groups | Controlled consumer view:; Server exposure and freshness: |
...
|---|---|---|
| project ledger current boundary equals commit-06-b | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-06-b exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-06-b exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-06-b readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-06-b title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 exposure/query flows; formal 04 activation rules; formal 05 no-write/binding | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | view material, visibility resolver/assembler, server exposure facade and freshness tests | planned |
| allowed_rule | BATCH-06-B1 view material -> BATCH-06-B2 resolver/assembler -> BATCH-06-B3 server facade -> BATCH-06-B4 freshness tests; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | query-triggered repair, runtime execution, SDK client/cache and marketplace listing | active |
...
|---|---|---|
| BATCH-06-B1 view material -> BATCH-06-B2 resolver/assembler -> BATCH-06-B3 server facade -> BATCH-06-B4 freshness tests | each batch is a 100-300 line locally verifiable increment | planned |
...
|---|---|
| primary_selector | CMD-018..021 |
| targeted_selector | QUERY-015..019; STATE-009..014; BIND exposure rows; JOB-002 read input |
...
| raw_report_contract | suites/service-command-query/exposure/; suites/domain-state/exposure/; suites/runtime-binding/; view/exposure report |
| evidence_contract | exposure accepted path, visibility resolver, controlled consumer view, freshness/degraded marker and no-write raw; JOB-002 is read input only |
| AC_VF_VETO_direction | AC-CH-005,014,019,020,028..030,033..037; VF-CH-007,008,009; VETO-CH-007,008; VETO-CH-P-008/009 |
| failure_return | query-triggered repair, runtime decision, SDK client/cache, marketplace listing or missing marker source blocks and may reopen formal 03 |
...
|---|---|---|
| targeted selector | CMD-018..021; QUERY-015..019; JOB-002 read input, expanded to exact TC/DS/EV identities at execution time | pending |
...
| commit_message_format | pending | Planned subject: feat(exposure-service): add controlled consumer exposure services |
| commit_body_group | pending | Required groups: Controlled consumer view:; Server exposure and freshness: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-07-a |
...
|---|---|---|---|---|---|
| BLK-CH-06-B-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

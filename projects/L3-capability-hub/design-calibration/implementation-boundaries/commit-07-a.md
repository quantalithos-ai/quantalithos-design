...
| item | contract |
|---|---|
| objective | Establish trace, impact, revision and safe capture service foundations. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-07-a |
| allowed scope | trace/impact/revision carriers, source/capture symmetry, safe observation and redaction tests |
| forbidden scope | raw audit/evidence backend truth, observer verdict and downstream ownership |
| batch sequence | BATCH-07-A1 trace carrier -> BATCH-07-A2 impact/revision -> BATCH-07-A3 source/capture symmetry -> BATCH-07-A4 redaction tests |
| primary or targeted selectors | CMD-022..023; QUERY-020..023; INBOUND-003 |
| readiness prerequisite | trace/impact/change/capture stores and safe observer fixture |
| gate set | GATE-01,GATE-02,GATE-03,GATE-04,GATE-05,GATE-06,GATE-07 |
| planned reviewer | trace owner + redaction reviewer |
| planned title | feat(trace-impact): add capability trace and impact services |
| required body groups | Trace and impact contracts:; Source symmetry and safe capture: |
| next boundary | commit-07-b |

## Activation Guard

| rule | status | consequence |
|---|---|---|
| project ledger current boundary equals commit-07-a | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-07-a exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-07-a exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-07-a readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-07-a title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 C22-C23/Q20-Q23/I03; DDD Steps 6,7,9,11,15; formal 05 trace/capture | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | trace/impact/revision carriers, source/capture symmetry, safe observation and redaction tests | planned |
| allowed_rule | BATCH-07-A1 trace carrier -> BATCH-07-A2 impact/revision -> BATCH-07-A3 source/capture symmetry -> BATCH-07-A4 redaction tests; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | raw audit/evidence backend truth, observer verdict and downstream ownership | active |
...
|---|---|---|
| BATCH-07-A1 trace carrier -> BATCH-07-A2 impact/revision -> BATCH-07-A3 source/capture symmetry -> BATCH-07-A4 redaction tests | each batch is a 100-300 line locally verifiable increment | planned |
...
|---|---|
| primary_selector | CMD-022..023 |
| targeted_selector | QUERY-020..023; INBOUND-003; trace/impact STATE/TX/OBS rows |
| planned_commands | cargo fmt --check; cargo check --workspace; cargo test --workspace -- trace-impact; run_pr_gate.sh --run-id <run_id> --artifact-root <root> --suite service-command-query,repository-transaction,observability-redaction --selector CMD-022..023,QUERY-020..023,INBOUND-003; check_case_manifest.sh --selector CMD-022..023; check_redaction.sh --scope trace-impact; check_artifact_report_pairing.sh --scope commit-07-a |
| gate_set | GATE-01,GATE-02,GATE-03,GATE-04,GATE-05,GATE-06,GATE-07 |
| raw_report_contract | suites/service-command-query/trace-impact/; suites/repository-transaction/; suites/observability-redaction/; trace/impact/redaction reports |
| evidence_contract | accepted change must carry exact source, scope, version, trace, revision, impact and capture; observer projection cannot become truth or evidence verdict |
| AC_VF_VETO_direction | AC-CH-018,021,025,029,030,032,036; VF-CH-009,011; VETO-CH-009,011; VETO-CH-P-005/008/009 |
| failure_return | source/capture/revision asymmetry, body leak, observer substitution or partial UoW blocks and returns to formal 03 |
...
|---|---|---|
| targeted selector | CMD-022..023; QUERY-020..023; INBOUND-003, expanded to exact TC/DS/EV identities at execution time | pending |
...
| commit_message_format | pending | Planned subject: feat(trace-impact): add capability trace and impact services |
| commit_body_group | pending | Required groups: Trace and impact contracts:; Source symmetry and safe capture: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-07-b |
...
|---|---|---|---|---|---|
| BLK-CH-07-A-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

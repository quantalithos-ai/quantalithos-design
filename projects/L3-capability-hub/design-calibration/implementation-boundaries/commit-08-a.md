...
| item | contract |
|---|---|
| objective | Establish shared query responses, markers and read-only Port foundations. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-08-a |
| allowed scope | shared Query DTO, page/cursor/marker contracts, read Ports and no-write fixtures |
| forbidden scope | mutation, refresh Job, new marker kind and UoW/save/reserve/capture Port |
| batch sequence | BATCH-08-A1 page/cursor -> BATCH-08-A2 marker/empty/degraded -> BATCH-08-A3 read Port/no-write fixtures |
| primary or targeted selectors | targeted QUERY-001..033 shared fixtures |
| readiness prerequisite | query DTO/page/marker/read Port fixture and no-write scan |
| gate set | GATE-01,GATE-02,GATE-03,GATE-07 |
| planned reviewer | query owner + contracts reviewer |
| planned title | feat(query): add query response and read port foundations |
| required body groups | Query response contracts:; Read-only port foundations: |
...
|---|---|---|
| project ledger current boundary equals commit-08-a | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-08-a exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-08-a exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-08-a readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-08-a title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 shared Query cards and read Ports; DDD Steps 8-9; formal 05 no-write cuts | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | shared Query DTO, page/cursor/marker contracts, read Ports and no-write fixtures | planned |
| allowed_rule | BATCH-08-A1 page/cursor -> BATCH-08-A2 marker/empty/degraded -> BATCH-08-A3 read Port/no-write fixtures; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | mutation, refresh Job, new marker kind and UoW/save/reserve/capture Port | active |
...
|---|---|---|
| BATCH-08-A1 page/cursor -> BATCH-08-A2 marker/empty/degraded -> BATCH-08-A3 read Port/no-write fixtures | each batch is a 100-300 line locally verifiable increment | planned |
...
| evidence_contract | page/cursor/marker/empty/degraded DTO and read Port must have formal source; every public struct field and variant payload needs English Rustdoc |
| AC_VF_VETO_direction | AC-CH-019,020,022,024,028,030,033..037; VF-CH-007,008; VETO-CH-007,008; VETO-CH-P-008 |
| failure_return | marker/source/DTO closure gap is wait_design; any UoW/save/reserve/capture interface blocks and returns to formal 03 |
...
|---|---|---|
| targeted selector | targeted QUERY-001..033 shared fixtures, expanded to exact TC/DS/EV identities at execution time | pending |
...
| commit_message_format | pending | Planned subject: feat(query): add query response and read port foundations |
| commit_body_group | pending | Required groups: Query response contracts:; Read-only port foundations: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-08-b |
...
|---|---|---|---|---|---|
| BLK-CH-08-A-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

...
| item | contract |
|---|---|
| objective | Complete the core Q01-Q19 capability query surfaces. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-08-b |
| allowed scope | Q01-Q19 query services, assemblers, API tests, visibility and no-write checks |
| forbidden scope | UoW/reserve/capture, query repair, runtime execution and side-effectful refresh |
| batch sequence | BATCH-08-B1 Q01-Q06 -> BATCH-08-B2 Q07-Q10 -> BATCH-08-B3 Q11-Q14 -> BATCH-08-B4 Q15-Q19/tests |
| primary or targeted selectors | QUERY-001..019 |
| readiness prerequisite | API core query root and visible/absent/degraded/freshness fixtures |
| gate set | GATE-01,GATE-02,GATE-03,GATE-04,GATE-06,GATE-07 |
| planned reviewer | query owner + capability-family owners |
| planned title | feat(query-core): add core capability query services |
| required body groups | Identity registry and descriptor queries:; Relation and exposure queries:; Core query safeguards: |
| next boundary | commit-08-c |

## Activation Guard

| rule | status | consequence |
|---|---|---|
| project ledger current boundary equals commit-08-b | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-08-b exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-08-b exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-08-b readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-08-b title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 Q01-Q19 exact flows/Ports/states; formal 05 main query/no-write | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | Q01-Q19 query services, assemblers, API tests, visibility and no-write checks | planned |
| allowed_rule | BATCH-08-B1 Q01-Q06 -> BATCH-08-B2 Q07-Q10 -> BATCH-08-B3 Q11-Q14 -> BATCH-08-B4 Q15-Q19/tests; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | UoW/reserve/capture, query repair, runtime execution and side-effectful refresh | active |
...
|---|---|---|
| BATCH-08-B1 Q01-Q06 -> BATCH-08-B2 Q07-Q10 -> BATCH-08-B3 Q11-Q14 -> BATCH-08-B4 Q15-Q19/tests | each batch is a 100-300 line locally verifiable increment | planned |
...
|---|---|
| primary_selector | QUERY-001..019 |
| targeted_selector | CMD-001..021; identity/registry/descriptor/relation/exposure states and visibility rows |
| planned_commands | cargo fmt --check; cargo check --workspace; cargo test --workspace -- core-capability-queries; run_main_gate.sh --run-id <run_id> --artifact-root <root> --entry api --selector QUERY-001..019; check_case_manifest.sh --selector QUERY-001..019; check_artifact_report_pairing.sh --scope commit-08-b; check_responsibility_boundary.sh --scope query-no-write |
| gate_set | GATE-01,GATE-02,GATE-03,GATE-04,GATE-06,GATE-07 |
| raw_report_contract | suites/service-command-query/query-core/; checks/case-manifest/; core query report |
| evidence_contract | 19 Query raw rows must distinguish visible, absent, NotVisible, degraded, stale and unavailable; UoW/save/reserve/capture/rebuild/repair must be zero |
| AC_VF_VETO_direction | AC-CH-001..020,023,024,028..030,033..037; VF-CH-003,004,005,006,007,008; VETO-CH-003..008; VETO-CH-P-008 |
| failure_return | any Query write, fallback, first-row inference or visibility leakage is a P0 hard failure; do not commit |
...
|---|---|---|
| targeted selector | QUERY-001..019, expanded to exact TC/DS/EV identities at execution time | pending |
...
| commit_message_format | pending | Planned subject: feat(query-core): add core capability query services |
| commit_body_group | pending | Required groups: Identity registry and descriptor queries:; Relation and exposure queries:; Core query safeguards: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-08-c |
...
|---|---|---|---|---|---|
| BLK-CH-08-B-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

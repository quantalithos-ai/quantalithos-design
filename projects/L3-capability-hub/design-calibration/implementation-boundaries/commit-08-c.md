...
| phase | PH-08 |
| design_baseline | planned-after-commit-08-b |
...
| item | contract |
|---|---|
| objective | Complete the extended Q20-Q33 trace, reference and material query surfaces. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-08-c |
| allowed scope | Q20-Q33 trace/reference/directory/export/material read surfaces and freshness/redaction tests |
| forbidden scope | Job refresh, event publish, truth repair and body-bearing material |
| batch sequence | BATCH-08-C1 Q20-Q23 -> BATCH-08-C2 Q24-Q28 -> BATCH-08-C3 Q29-Q33 -> BATCH-08-C4 material/report reads |
| primary or targeted selectors | QUERY-020..033 |
| readiness prerequisite | material/report read stores, freshness, degraded and redaction fixtures |
| gate set | GATE-01,GATE-02,GATE-03,GATE-04,GATE-05,GATE-06,GATE-07 |
| planned reviewer | query owner + material/redaction reviewers |
| planned title | feat(query-extended): add trace and material query services |
| required body groups | Trace impact and directory queries:; Reference and material queries:; Extended query safeguards: |
| next boundary | commit-09-a |

## Activation Guard

| rule | status | consequence |
|---|---|---|
| project ledger current boundary equals commit-08-c | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-08-c exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-08-c exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-08-c readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-08-c title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 Q20-Q33/material sources; formal 05 extended query/material/redaction | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | Q20-Q33 trace/reference/directory/export/material read surfaces and freshness/redaction tests | planned |
| allowed_rule | BATCH-08-C1 Q20-Q23 -> BATCH-08-C2 Q24-Q28 -> BATCH-08-C3 Q29-Q33 -> BATCH-08-C4 material/report reads; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | Job refresh, event publish, truth repair and body-bearing material | active |
...
|---|---|---|
| BATCH-08-C1 Q20-Q23 -> BATCH-08-C2 Q24-Q28 -> BATCH-08-C3 Q29-Q33 -> BATCH-08-C4 material/report reads | each batch is a 100-300 line locally verifiable increment | planned |
...
|---|---|
| primary_selector | QUERY-020..033 |
| targeted_selector | CMD-022..026; trace/reference/directory/material/report states and redaction rows |
| planned_commands | cargo fmt --check; cargo check --workspace; cargo test --workspace -- extended-capability-queries; run_main_gate.sh --run-id <run_id> --artifact-root <root> --entry api --selector QUERY-020..033; check_case_manifest.sh --selector QUERY-020..033; check_redaction.sh --scope query-material; check_artifact_report_pairing.sh --scope commit-08-c; check_responsibility_boundary.sh --scope query-no-write |
| gate_set | GATE-01,GATE-02,GATE-03,GATE-04,GATE-05,GATE-06,GATE-07 |
| raw_report_contract | suites/service-command-query/query-extended/; suites/observability-redaction/; extended query/material reports |
| evidence_contract | 14 Query raw rows must retain source, version, freshness, degraded and body-free markers; directory/export/report is read-only and cannot generate or repair truth |
| AC_VF_VETO_direction | AC-CH-011,018..022,024,028,030..037; VF-CH-007,008,009,011; VETO-CH-007,008,009,011; VETO-CH-P-005/008 |
| failure_return | material source or freshness gap is wait_design; job refresh, event publish or truth repair is an immediate block |
...
|---|---|---|
| targeted selector | QUERY-020..033, expanded to exact TC/DS/EV identities at execution time | pending |
...
| commit_message_format | pending | Planned subject: feat(query-extended): add trace and material query services |
| commit_body_group | pending | Required groups: Trace impact and directory queries:; Reference and material queries:; Extended query safeguards: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-09-a |
...
|---|---|---|---|---|---|
| BLK-CH-08-C-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

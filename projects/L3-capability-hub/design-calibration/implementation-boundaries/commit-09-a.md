...
| phase | PH-09 |
| design_baseline | planned-after-commit-08-c |
...
| item | contract |
|---|---|
| objective | Complete inbound receipts, header-first intake and worker source lifecycle seams. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-09-a |
...
| planned title | feat(inbound): add inbound receipt and worker intake seams |
| required body groups | Header-first intake contracts:; Receipt and replay behavior:; Inbound worker lifecycle: |
...
|---|---|---|
| project ledger current boundary equals commit-09-a | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-09-a exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-09-a exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-09-a readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-09-a title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 I01-I06 cards/flows; formal 04 Worker bindings; formal 05 entry-inbound/replay | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | six inbound DTOs, header gate, receipt/dedup stores and worker lifecycle | planned |
| allowed_rule | BATCH-09-A1 envelope/header -> BATCH-09-A2 receipt store -> BATCH-09-A3 dedup/replay -> BATCH-09-A4 worker lifecycle tests; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | core truth merge, payload body logging, approval/method writes and delivery ownership | active |
...
|---|---|---|
| BATCH-09-A1 envelope/header -> BATCH-09-A2 receipt store -> BATCH-09-A3 dedup/replay -> BATCH-09-A4 worker lifecycle tests | each batch is a 100-300 line locally verifiable increment | planned |
...
| commit_message_format | pending | Planned subject: feat(inbound): add inbound receipt and worker intake seams |
| commit_body_group | pending | Required groups: Header-first intake contracts:; Receipt and replay behavior:; Inbound worker lifecycle: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-09-b |
...
|---|---|---|---|---|---|
| BLK-CH-09-A-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

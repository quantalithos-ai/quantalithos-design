...
| phase | PH-10 |
| design_baseline | planned-after-commit-09-b |
...
| item | contract |
|---|---|
| objective | Establish public Job protocol, journal, frozen plan and typed report foundations. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-10-a |
...
| planned title | feat(jobs): add job protocol journal and report foundations |
| required body groups | Job protocol and journal:; Frozen plans and typed reports: |
...
|---|---|---|
| project ledger current boundary equals commit-10-a | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-10-a exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-10-a exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-10-a readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-10-a title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 J01-J08 cards/flows; DDD Steps 6,8,11,13; formal 05 Job protocol | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | J01-J08 public carriers, journal/checkpoint, frozen plan/target and result/report shell | planned |
| allowed_rule | BATCH-10-A1 Job input -> BATCH-10-A2 journal/checkpoint -> BATCH-10-A3 frozen plan/target -> BATCH-10-A4 result/report carriers; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | generic execute, scheduler-owned behavior and Job business mutation | active |
...
|---|---|---|
| BATCH-10-A1 Job input -> BATCH-10-A2 journal/checkpoint -> BATCH-10-A3 frozen plan/target -> BATCH-10-A4 result/report carriers | each batch is a 100-300 line locally verifiable increment | planned |
...
| commit_message_format | pending | Planned subject: feat(jobs): add job protocol journal and report foundations |
| commit_body_group | pending | Required groups: Job protocol and journal:; Frozen plans and typed reports: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-10-b |
...
|---|---|---|---|---|---|
| BLK-CH-10-A-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

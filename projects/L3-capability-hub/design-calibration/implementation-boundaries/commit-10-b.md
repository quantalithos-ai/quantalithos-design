...
| phase | PH-10 |
| design_baseline | planned-after-commit-10-a |
...
| item | contract |
|---|---|
| objective | Complete J01-J07 derived, material and reconciliation Job families. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-10-b |
| allowed scope | J01-J07 target selection, read-material refresh and immutable terminal reports |
| forbidden scope | current truth repair, scope rescan, listing/marketplace and blind retry |
| batch sequence | BATCH-10-B1 J01-J02 -> BATCH-10-B2 J03-J05 -> BATCH-10-B3 J06-J07 -> BATCH-10-B4 terminal reports/tests |
| primary or targeted selectors | JOB-001..007 |
| readiness prerequisite | frozen targets, material stores, journal/report/replay harness |
| gate set | GATE-01,GATE-02,GATE-03,GATE-04,GATE-05,GATE-06,GATE-07 |
| planned reviewer | jobs owner + material owner |
| planned title | feat(jobs-derived): add derived material and reconciliation jobs |
| required body groups | Derived material jobs:; Reconciliation and terminal reports: |
| next boundary | commit-10-c |

## Activation Guard

| rule | status | consequence |
|---|---|---|
| project ledger current boundary equals commit-10-b | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-10-b exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-10-b exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-10-b readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-10-b title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 03 J01-J07 exact flows/state/TX; formal 05 no-repair/replay | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | J01-J07 target selection, read-material refresh and immutable terminal reports | planned |
| allowed_rule | BATCH-10-B1 J01-J02 -> BATCH-10-B2 J03-J05 -> BATCH-10-B3 J06-J07 -> BATCH-10-B4 terminal reports/tests; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | current truth repair, scope rescan, listing/marketplace and blind retry | active |
...
|---|---|---|
| BATCH-10-B1 J01-J02 -> BATCH-10-B2 J03-J05 -> BATCH-10-B3 J06-J07 -> BATCH-10-B4 terminal reports/tests | each batch is a 100-300 line locally verifiable increment | planned |
...
|---|---|
| primary_selector | JOB-001..007 |
| targeted_selector | QUERY-024..028; material/reference states; job TX/BIND/CONFIG/OBS rows |
| planned_commands | cargo fmt --check; cargo check --workspace; cargo test --workspace -- derived-material-jobs; run_main_gate.sh --run-id <run_id> --artifact-root <root> --entry jobs --selector JOB-001..007; check_case_manifest.sh --selector JOB-001..007; check_state_pair_registry.sh --scope jobs; check_artifact_report_pairing.sh --scope commit-10-b; check_responsibility_boundary.sh --scope job-no-repair |
| gate_set | GATE-01,GATE-02,GATE-03,GATE-04,GATE-05,GATE-06,GATE-07 |
| raw_report_contract | suites/jobs-lifecycle/derived/; suites/repository-transaction/jobs/; checks/state-pair/; job/material reports |
| evidence_contract | frozen target selection, ordinal journal, per-target immutable outcome and final report are complete; maintenance refreshes derived material only and never repairs identity/registry/exposure |
| AC_VF_VETO_direction | AC-CH-002,005,011,018,022,024,028,030,033..037; VF-CH-007,008,009,010; VETO-CH-007..010; VETO-CH-P-008/009 |
| failure_return | rescan/replan, partial target loss, current truth repair, duplicate mutation or report gap is a P0 hard failure |
...
|---|---|---|
| targeted selector | JOB-001..007, expanded to exact TC/DS/EV identities at execution time | pending |
...
| commit_message_format | pending | Planned subject: feat(jobs-derived): add derived material and reconciliation jobs |
| commit_body_group | pending | Required groups: Derived material jobs:; Reconciliation and terminal reports: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-10-c |
...
|---|---|---|---|---|---|
| BLK-CH-10-B-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

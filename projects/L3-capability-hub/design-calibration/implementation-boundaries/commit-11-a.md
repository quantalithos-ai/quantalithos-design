...
| phase | PH-11 |
| design_baseline | planned-after-commit-10-c |
...
| item | contract |
|---|---|
| objective | Establish run-scoped raw, report, check and evidence-index builders. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-11-a |
...
|---|---|---|
| project ledger current boundary equals commit-11-a | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-11-a exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-11-a exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-11-a readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-11-a title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 05 §§9,13; formal 06 §§10-11; evidence calibration | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | run-scoped scripts, report/check builders, machine schemas and pairing/redaction/no-static audits | planned |
| allowed_rule | BATCH-11-A1 raw schemas -> BATCH-11-A2 suite/report builders -> BATCH-11-A3 checks/audits -> BATCH-11-A4 evidence index; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | static pass, cross-run joins, acceptance signoff and manual evidence fabrication | active |
...
|---|---|---|
| BATCH-11-A1 raw schemas -> BATCH-11-A2 suite/report builders -> BATCH-11-A3 checks/audits -> BATCH-11-A4 evidence index | each batch is a 100-300 line locally verifiable increment | planned |
...
| commit_message_format | pending | Planned subject: feat(report): add run reports and evidence index builders |
| commit_body_group | pending | Required groups: Run-scoped raw and reports:; Provenance and safety audits:; Evidence candidate indexing: |
...
| next_boundary | pending | Must match project ledger after real handoff: commit-11-b |
...
|---|---|---|---|---|---|
| BLK-CH-11-A-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

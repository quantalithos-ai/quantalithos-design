...
| phase | PH-11 |
| design_baseline | planned-after-commit-11-a |
...
| item | contract |
|---|---|
| objective | Establish release smoke and pending acceptance/review handoff shells. |
| formal authority | 07-实施计划.md §6.4 and exact Step 6/7/8/10/11 rows for commit-11-b |
| allowed scope | release aggregation, smoke and pending acceptance/review/VETO/risk/open-issue drafts |
| forbidden scope | final human verdict, risk auto-acceptance, real signature and default approval |
| batch sequence | BATCH-11-B1 release gate -> BATCH-11-B2 VETO/handoff drafts -> BATCH-11-B3 review/open-issue/risk schemas |
| primary or targeted selectors | release aggregation; 37 AC; 13 VF; 23 VETO directions |
| readiness prerequisite | compatible lower-run manifest, acceptance/review draft schema and selected refs where required |
| gate set | GATE-01,GATE-06,GATE-07,GATE-08,GATE-09 |
| planned reviewer | release owner + authorized acceptance/review owners |
| planned title | feat(release): add release smoke and acceptance handoff shells |
| required body groups | Release gate aggregation:; Acceptance and review handoff: |
...
|---|---|---|
| project ledger current boundary equals commit-11-b | pending | Future boundary stays inactive until project ledger advances. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_06_tasks_commit_boundaries.md | commit-11-b exact row and batches | pending | Exact boundary contract. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_07_tests_acceptance_gates.md | commit-11-b exact gate and evidence row | pending | Exact gate authority. |
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_08_config_environment_dependencies.md | commit-11-b readiness row | pending | Exact prerequisite behavior. |
...
| projects/L3-capability-hub/design-calibration/07_implementation_plan_step_11_commit_review_delivery.md | commit-11-b title/body/reviewer/handoff | pending | Planned message only. |
| formal upstream sources | formal 05 §§13-14; formal 06 §§11-15; release and review calibration | pending | Formal 03/04/05/06 remain schema and oracle authority. |

## Allowed Scope

| type | path_or_rule | status |
|---|---|---|
| allowed_rule | release aggregation, smoke and pending acceptance/review/VETO/risk/open-issue drafts | planned |
| allowed_rule | BATCH-11-B1 release gate -> BATCH-11-B2 VETO/handoff drafts -> BATCH-11-B3 review/open-issue/risk schemas; each batch is a 100-300 line locally verifiable increment | planned |
...
| forbidden_rule | final human verdict, risk auto-acceptance, real signature and default approval | active |
...
|---|---|---|
| BATCH-11-B1 release gate -> BATCH-11-B2 VETO/handoff drafts -> BATCH-11-B3 review/open-issue/risk schemas | each batch is a 100-300 line locally verifiable increment | planned |
...
| evidence_contract | handoff/VETO/open-issues/risk/review drafts must list explicit run IDs, provenance, status and review ownership; no default verdict/signoff |
| AC_VF_VETO_direction | AC-CH-001..037; VF-CH-001..013; VETO-CH-001..013; VETO-CH-P-001..010 |
| failure_return | any lower-run, check, builder, VETO, review or authorization gap remains not_decided/blocked; scripts cannot auto-conditionally pass |
...
|---|---|---|
| targeted selector | release aggregation; 37 AC; 13 VF; 23 VETO directions, expanded to exact TC/DS/EV identities at execution time | pending |
...
| commit_message_format | pending | Planned subject: feat(release): add release smoke and acceptance handoff shells |
| commit_body_group | pending | Required groups: Release gate aggregation:; Acceptance and review handoff: |
...
| next_boundary | pending | Must match project ledger after real handoff: handoff |
...
|---|---|---|---|---|---|
| BLK-CH-11-B-ACTIVATION-001 | activation_gate | planned | Project ledger has not advanced to this future boundary. | Advance the project ledger through the predecessor handoff and set this boundary current. | wait_until_current |

...
| `Active` / `Superseded` | `RetireFormalMethodAssetVersionFlow` | exact version read;consumption material / impact refs remain traceable;retirement reason accepted | `Retired` | retired event candidate;impact summary candidate |
